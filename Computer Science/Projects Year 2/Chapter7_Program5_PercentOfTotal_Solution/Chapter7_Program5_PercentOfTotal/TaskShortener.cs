...
namespace Chapter7_Program5_PercentOfTotal
{
    internal class TaskShortener : Colors
    {
        ...
        internal static string name = "Ethan Lawrence\t   ", period = "\t   Period 4,5,6",
            teacher = "\t    Mr. Lynch", purpose = "\nPurpose: Get the sum of an array and the first numbers contribution to that sum."
                + "", endheader = "\n*************************************"
                + "*******************************************\n\n";
        ...
        {
            CyanFont();
            Console.Title = "Chapter7_Program5_PercentOfTotal";
        ...
        internal static void ConsoleChangeSize(double x, double y)
        {
            int origWidth = Console.WindowWidth;
            int origHeight = Console.WindowHeight;
            Console.SetWindowSize((int)(origWidth * x), (int)(origHeight * y));
        }
