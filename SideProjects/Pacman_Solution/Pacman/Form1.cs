...
namespace Pacman
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                case Keys.W:
                    (PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Up);
                    break;

                case Keys.S:
                    (PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Down);
                    break;

                case Keys.A:
                    (PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Left);
                    break;

                case Keys.D:
                    (PacmanGroupBox.Controls[0] as Characters.ICharacter).Move(Characters.MovementWay.Right);
                    break;
            }
        }
