...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "I love sports! Please Tell me more!";
			
				}
		else if (findKeyword(statement, "vegetables") >= 0
		
				|| findKeyword( statement, "fruit") >= 0
				|| findKeyword( statement,"chocolate") >= 0
				|| findKeyword( statement,"food") >= 0
				|| findKeyword( statement,"pasta") >= 0)
			
		{
			response = "I had that for dinner last night!";
		...
		{
			response = "My favorite TV show is prison break. Have you seen it?";
