...
class MainClass {
  public static void Main (string[] args) {
    ...
    Console.ForegroundColor = ConsoleColor.Cyan; //Sets the color to Cyan
        string name = "Ethan Lawrence"; //Allows me to type my name in a shorter amount of time
        string date = "\t"+DateTime.Now; //Gives an accurate date and time of when the project is being graded
        string period = "\tPeriod 4,5,6"; //Shows what periods the class is from
        string teacher = "\tMr. Lynch"; //Shows my teacher's last name
        string endheader = "\n********************************************************************************"; //Ends the header
        ...
        Console.WriteLine(name+date); //Writes my name and the date w/ the time
        ...
        Console.WriteLine(name+date+period); //Writes my name, the date w/ the time, and the period
        ...
        Console.WriteLine(name+date+period+teacher); //Writes my name, the date w/ the time, period, and teacher name
        ...
        Console.WriteLine(name+date+period+teacher+endheader); //Writes my name, the date w/ the time, period, teacher name, and ends the header
        Thread.Sleep(130); //"Loading" Time
